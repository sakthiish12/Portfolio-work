...
BeSwapChain::BeSwapChain(
    BeDevice &deviceRef, VkExtent2D extent, std::shared_ptr<BeSwapChain> previous)
...
VkResult BeSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers, uint32_t *imageIndex) {
