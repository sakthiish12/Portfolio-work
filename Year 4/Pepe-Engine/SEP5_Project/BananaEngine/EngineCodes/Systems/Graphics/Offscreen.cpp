...
namespace BE 
{
    OffScreen::OffScreen(BeDevice& device) : m_Device{ device } {
        *pass.width = 1920;
        *pass.height = 1080;
        ...
        noEditBgColor[0] = (float)0.01;
        noEditBgColor[1] = (float)0.01;
        noEditBgColor[2] = (float)0.01;
