...
namespace BE {
    ...
    public:
        ...
        void copyBufferToImageForFont(
            VkBuffer buffer, VkImage image, uint32_t width, uint32_t height, int offsetX,int offsetY);
        ...
        void transitionImageLayout2(VkImage& image, VkImageLayout oldLayout, VkImageLayout newLayout);
