...
struct ImGuiStorage
{
    struct Pair
    {
        ...
        Pair(ImGuiID _key, int _val_i) { key = _key; val_i = _val_i;  val_p = nullptr ; } //initialising val_p 
        Pair(ImGuiID _key, float _val_f) { key = _key; val_f = _val_f; val_p = nullptr; } //initialising val_p 
