...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            ImGui::InputFloat("input float", &f0, 0.05f, 1.0f, "%.3f");

            static double d0 = 999999.00000001;
            ImGui::InputDouble("input double", &d0, 0.05f, 1.0f, "%.8f");
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::DragFloat4("Raw HSV values", (float*)&color_hsv, 0.05f, 0.0f, 1.0f);
    ...
    if (ImGui::TreeNode("Multi-component Widgets"))
    {
        ...
        ImGui::DragFloat2("drag float2", vec4f, 0.05f, 0.0f, 1.0f);
        ...
        ImGui::DragFloat3("drag float3", vec4f, 0.05f, 0.0f, 1.0f);
        ...
        ImGui::DragFloat4("drag float4", vec4f, 0.05f, 0.0f, 1.0f);
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Rendering"))
        {
            ...
            ImGui::DragFloat("Circle Segment Max Error", &style.CircleSegmentMaxError, 0.05f, 0.10f, 10.0f, "%.2f");
            if (ImGui::IsItemActive())
            {
