...
//  */
//  /******************************************************************************/
#ifndef _PAUSEOPTIONGAMESCRIPT_H_
#define _PAUSEOPTIONGAMESCRIPT_H_

struct scriptBase;
struct PauseOptionGameScript : scriptBase
{
	//CPP TaskListScript
	//base data
	...
	//functions
	PauseOptionGameScript(const char* scriptName = "PauseOptionGameScript");
