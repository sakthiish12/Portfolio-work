...
//  */
//  /******************************************************************************/
#ifndef _BUSH_SCRIPT_H_
#define _BUSH_SCRIPT_H_

struct scriptBase;
struct BushScript : scriptBase
{
	...
	//base data
	std::string name{ "BushScript" }; //name identifier

	

	//functions
	BushScript(const char* scriptName = "BushScript");
