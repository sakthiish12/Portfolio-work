...
//  */
//  /******************************************************************************/
#ifndef _TOMOSPLASHSCRIPT_H_
#define _TOMOSPLASHSCRIPT_H_
#include "../../Engine/ECS/component.h"
struct scriptBase;
struct TomoSplashScript : scriptBase
{
	//CPP TaskListScript
	//base data
	std::string name{ "TomoSplashScript" }; //name identifier
	...
	//functions
	TomoSplashScript(const char* scriptName = "TomoSplashScript");
