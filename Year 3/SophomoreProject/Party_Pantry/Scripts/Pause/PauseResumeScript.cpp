// /******************************************************************************/
// /*!
// \file         PauseResumeScript.cpp
// \project name Engine
// \author(s)    Wilfred Ng Jun Hwee 
// \date         8th Dec, 2021 <Date of last SIGNIFICANT CHANGE>
// \brief        This file contains the function definition of the pause resume script 
// \lines        
// 
...
PauseResumeScript::PauseResumeScript(const char* scriptName) :
	scriptBase(scriptName)
{
}

void PauseResumeScript::init(float dt, unsigned int idToBeSet)
{
...
void PauseResumeScript::update(float dt)
{
	UNREFERENCED_PARAMETER(dt);
...
void PauseResumeScript::end(float dt)
{
	UNREFERENCED_PARAMETER(dt);
	cout << "end()" << endl;
}

std::shared_ptr<scriptBase> PauseResumeScript::createCopy()
{
	return std::make_shared <PauseResumeScript>();
}

std::string PauseResumeScript::getScriptName()
{
	return name;
}
