...
//  */
//  /******************************************************************************/
#ifndef _UPGRADEDIALOGUE1SCRIPT_H_
#define _UPGRADEDIALOGUE1SCRIPT_H_
#include "../../../Engine/ECS/component.h"
struct scriptBase;
struct UpgradeDialogue1Script : scriptBase
{
	//CPP TaskListScript
	//base data
	std::string name{ "UpgradeDialogue1Script" }; //name identifier
	entityID playerID;//stores the player id 
	bool dialogueActivated = false;
	//functions
	UpgradeDialogue1Script(const char* scriptName = "UpgradeDialogue1Script");
